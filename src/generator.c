...
int main(int argc, char const *argv[])
{
    ...
    #if NUM_FILE == 4
    generate_graph(25, "INPUT_FILE1", 2, 0, 100);
    generate_graph(25, "INPUT_FILE2", 2, 25, 100);
    generate_graph(25, "INPUT_FILE3", 2, 50, 100);
    generate_graph(25, "INPUT_FILE4", 2, 75, 100);
    #endif
